...
let favoriteFoods=['pizza', 'ice cream', 'popcorn'];
...
console.log('Forth animal is', animalArray[3]);
...
let removedFavFood = favoriteFoods.pop();
...
//     log both the food removed and the updated array
removedFavFood = favoriteFoods.shift();
console.log('removed the first food', removedFavFood);
console.log('The favorite foods are now', favoriteFoods);
